...
for f in precip_files[0::]:
    ...
    if int(month) in [6,7,8]:
        ...
        if os.path.isfile(fi) == True:
            ...
            # Creating dimensions
            data = Dataset('/media/juli/Data/projects/data/satellite_data/ncep/ctt/Save/tbbtracking_revised/mcs_contr_precip'+str(year)+ str(month) + '_extr.nc4','w', format = 'NETCDF4_CLASSIC')
