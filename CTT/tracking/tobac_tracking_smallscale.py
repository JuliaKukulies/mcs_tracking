...
for f in file_list[61::]:
    ...
    Features.to_hdf(os.path.join(savedir,'smallscale50/Features_' + str(i) + '.h5'),'table')
    ...
    iris.save([Mask],os.path.join(savedir,'smallscale50/Mask_Segmentation_' + str(i) + '.nc'),zlib=True,complevel=4)                
    Features_Precip.to_hdf(os.path.join(savedir,'smallscale50/Features_cells_' + str(i) + '.h5'),'table')
