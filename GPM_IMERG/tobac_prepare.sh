...
do
	...
	for d in {01..31}
	do
	    rm ${y}/gpm_imerg_${y}${m}${d}_cat.nc4
	    rm ${y}/3B-HHR.MS.MRG.3IMERG.${y}${m}${d}*.V06B.HDF5.nc4 
	    cdo cat 3B-HHR.MS.MRG.3IMERG.${y}${m}${d}*.V06B.HDF5.nc4 ${y}/gpm_imerg_${y}${m}${d}_cat.nc4 
	...
	rm gpm_imerg_${y}${m}_tobac_input.nc4   
